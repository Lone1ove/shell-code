...
"""
import logging
from shell_agent.config import AgentConfig
from shell_agent.executor.base import BaseExecutor
...
def get_executor(config: AgentConfig) -> BaseExecutor:
    ...
    try:
        from shell_agent.executor.docker_native import DockerExecutor
        log_system_event(
...
def get_python_executor(config: AgentConfig) -> BaseExecutor:
    ...
    from shell_agent.executor.docker_python_wrapper import DockerPythonExecutor
