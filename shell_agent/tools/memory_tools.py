...
题目隔离机制：
- 使用 namespace=("shell_agent", "challenge", "{langgraph_user_id}")
...
from shell_agent.common import log_security_event, log_system_event
...
manage_memory = create_manage_memory_tool(
    namespace=("shell_agent", "challenge", "{langgraph_user_id}"),
